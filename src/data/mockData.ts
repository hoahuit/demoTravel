...
export const MOCK_TOURS: TourPackage[] = [
  {
    ...
    heroImage: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=1600&auto=format&fit=crop',
    gallery: [
...
export const MOCK_PRODUCTS = [
  {
    id: 'prod-1',
    name: 'Trà Shan Tuyết Cổ Thụ Suối Giàng 300 Năm',
  ...
  {
    id: 'prod-2',
    name: 'Nến Thơm Hoàng Đàn & Trầm Hương Tĩnh Tâm',
    slug: 'nen-thom-hoang-dan-tram-huong',
    category: 'Nến Thơm & Tinh Dầu',
    price: 890000,
  ...
  {
    id: 'prod-3',
    name: 'Túi Du Lịch Da Bò Sáp Canvas Cao Cấp Ethereal',
    slug: 'tui-du-lich-da-bo-canvas-ethereal',
    ...
    description: 'Thiết kế thủ công tinh xảo từ da bò sáp nguyên tấm và vải canvas chống thấm nước, bền bỉ qua năm tháng và đồng hành trọn vẹn trong các kỳ nghỉ dưỡng.',
    origin: 'Việt Nam'
  },
  {
    id: 'prod-4',
    name: 'Bộ Thiền Phục Linen Tự Nhiên Dáng Suông',
    slug: 'bo-thien-phuc-linen-tu-nhien',
    category: 'Thời Trang Nghỉ Dưỡng',
    price: 1850000,
  ...
  {
    id: 'prod-5',
    name: 'Bình Giữ Nhiệt Gốm Sứ Mộc Tráng Men Tro',
    slug: 'binh-giu-nhiet-gom-su-moc',
    category: 'Phụ Kiện Du Lịch',
    price: 680000,
    ...
    description: 'Lõi sứ tráng men tro tự nhiên giữ trọn vẹn hương vị của trà thảo mộc suốt 12 giờ, vỏ thép không gỉ nhám mờ thanh lịch.',
    origin: 'Bát Tràng'
  },
  {
    id: 'prod-6',
    name: 'Tinh Dầu Trầm Hương Xứ Quảng Tinh Khiết 10ml',
    slug: 'tinh-dau-tram-huong-xu-quang',
    category: 'Nến Thơm & Tinh Dầu',
    price: 2450000,
    ...
    description: 'Chiết xuất từ gỗ trầm tự nhiên Tiên Phước Quảng Nam, hương thơm sâu lắng mang năng lượng ấm áp, thanh tẩy không gian và xua tan căng thẳng.',
    origin: 'Quảng Nam'
  }
];
