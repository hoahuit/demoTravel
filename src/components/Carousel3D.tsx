...
const CARDS: CardItem[] = [
  ...
  },
  {
    ...
    title: "Bật Mí Bí Mật",
    subtitle: "Bà Rịa • Giải Thỏa Stress & Phục Hồi",
    ...
    price: "3.850.000đ",
    duration: "2 Ngày 1 Đêm",
    transport: "Xe Riêng May Đo",
    description: "Hành trình giải tỏa hội chứng 'quá tải' của cuộc sống hiện đại. Trở về với Thân, Tâm & Trí để tái tạo nguồn năng lượng thanh khiết và làm chủ cảm xúc.",
  },
  {
    id: 3,
    tag: "KHÔNG THỂ BỎ LỠ",
  ...
  },
  {
    ...
    subtitle: "Bình Châu • Suối Khoáng & Phục Hồi",
    footer: "4U Organic Spa & Healing",
    img: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=80&w=1000&auto=format&fit=crop",
    accent: "#f2b632",
    location: "Bình Châu / Hồ Tràm",
    price: "4.650.000đ",
    duration: "2 Ngày 1 Đêm",
    transport: "Xe Limousine Đưa Đón",
    description: "Kết hợp ngâm khoáng nóng thiên nhiên và liệu pháp thiền định, giúp giải tỏa mệt mỏi, nuôi dưỡng giấc ngủ ngon và tái tạo thể chất tràn đầy sự sống động.",
  },
  {
    id: 5,
    tag: "Retreat HOT",
    title: "Trở Về Yêu Thương",
    subtitle: "Hội An • Kết Nối Gia Đình & Nhóm",
    footer: "4U Family & Team Retreat",
    img: "https://images.unsplash.com/photo-1519046904884-53103b34b201?q=80&w=1000&auto=format&fit=crop",
    accent: "#f2b632",
    location: "Hội An / Đà Nẵng",
    price: "5.200.000đ",
    duration: "3 Ngày 2 Đêm",
    transport: "Xe Riêng VIP",
    description: "Kết nối và hàn gắn các mối quan hệ với Bản thân, Gia đình và những Người xung quanh. Tham gia hoạt động thiện nguyện, lan tỏa yêu thương và nuôi dưỡng lòng trắc ẩn.",
  },
];
