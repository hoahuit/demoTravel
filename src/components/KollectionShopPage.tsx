                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'center', flexWrap: 'wrap' }}>
                      <div style={{
                        ...
                        <img
                          src={`https://api.vietqr.io/image/970416-59584569-compact.png?amount=${cartTotalPrice}&addInfo=${encodeURIComponent('4U ' + (orderForm.phone ? orderForm.phone.replace(/\s+/g, '') : 'KOLLECTION'))}&accountName=CONG%20TY%20CP%20THUONG%20MAI%20DU%20LICH%20BON%20TOI%20UU`}
                      ...
                      <div style={{ flex: 1, minWidth: '160px', fontSize: '12px', color: '#334155', display: 'flex', flexDirection: 'column', gap: '3px' }}>
                        <div><span style={{ color: '#64748b' }}>Ngân hàng:</span> <strong style={{ color: '#081f13' }}>Ngân hàng TMCP Á Châu (ACB)</strong></div>
                        <div><span style={{ color: '#64748b' }}>Chi nhánh:</span> <strong style={{ color: '#081f13' }}>ACB - PGD NGUYEN DU</strong></div>
                        <div><span style={{ color: '#64748b' }}>Số tài khoản:</span> <strong style={{ color: '#065f46', fontFamily: 'monospace', fontSize: '13px' }}>5958 4569</strong></div>
                        <div><span style={{ color: '#64748b' }}>Chủ tài khoản:</span> <strong style={{ color: '#081f13' }}>CONG TY CP THUONG MAI DU LICH BON TOI UU</strong></div>
              ...
              <div style={{ padding: 'clamp(6px, 1vh, 12px) 0' }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <img
                      src={`https://api.vietqr.io/image/970416-59584569-compact.png?amount=${lastPlacedOrder?.totalAmount || finalCombinedTotalPrice}&addInfo=${encodeURIComponent('4U ' + (lastOrderCode || 'KOLLECTION'))}&accountName=CONG%20TY%20CP%20THUONG%20MAI%20DU%20LICH%20BON%20TOI%20UU`}
                      alt="Mã QR Chuyển Khoản ACB"
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>
                  <div style={{ fontSize: '12px', color: '#334155', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                    <div><span style={{ color: '#64748b' }}>Ngân hàng:</span> <strong style={{ color: '#081f13' }}>ACB (PGD NGUYEN DU)</strong></div>
                    <div><span style={{ color: '#64748b' }}>Số TK:</span> <strong style={{ fontFamily: 'monospace', color: '#065f46' }}>5958 4569</strong></div>
                    <div><span style={{ color: '#64748b' }}>Chủ TK:</span> <strong>CONG TY CP THUONG MAI DU LICH BON TOI UU</strong></div>
