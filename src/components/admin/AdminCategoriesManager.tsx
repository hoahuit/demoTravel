    ...
    <div style={{ padding: '4px' }}>
      ...
      >
        <div>
          ...
          >
            Quản Lý Danh Mục & Menu (Categories)
          </h1>
          <p style={{ fontSize: '13px', color: '#4d6453', margin: 0 }}>
            Quản lý quan hệ Cha - Con cho Menu Header và cho phép gán nhiều danh mục cho mỗi Tour
          </p>
        </div>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <button
            ...
            style={{
              ...
              fontSize: '13px',
              cursor: 'pointer',
              boxShadow: '0 4px 12px rgba(8, 31, 19, 0.15)',
